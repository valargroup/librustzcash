...
/// Version 1 of the Partially Created Zcash Transaction format.
pub mod v1 {
    use alloc::vec::Vec;
    ...
    use {
        crate::common::{Global, determine_lock_time},
...
#[cfg(any(feature = "io-finalizer", feature = "signer", feature = "tx-extractor"))]
pub(crate) use v1::ParsedPczt;

#[cfg(any(feature = "io-finalizer", feature = "signer"))]
pub(crate) use v1::sighash;

#[cfg(any(feature = "io-finalizer", feature = "signer", feature = "tx-extractor"))]
pub use v1::ExtractError;

#[cfg(any(feature = "io-finalizer", feature = "signer"))]
pub use v1::EffectsOnly;

pub use v1::{ParseError, Pczt};
