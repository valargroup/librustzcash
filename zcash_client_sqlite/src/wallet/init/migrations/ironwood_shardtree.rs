//! Adds storage for Ironwood note commitment tree data using the `shardtree` crate.
...
use super::orchard_note_version_uniqueness;
...
const DEPENDENCIES: &[Uuid] = &[orchard_note_version_uniqueness::MIGRATION_ID];
...
impl<P: consensus::Parameters> Migration<P> {
    fn nu7_activation_height(&self) -> Option<BlockHeight> {
        #[cfg(zcash_unstable = "nu7")]
        {
            self.params.activation_height(NetworkUpgrade::Nu7)
        }
...
impl<P: consensus::Parameters> RusqliteMigration for Migration<P> {
    ...
    fn up(&self, transaction: &rusqlite::Transaction) -> Result<(), WalletMigrationError> {
        ...
        // If this wallet has already scanned NU7-era blocks, requeue from NU7 activation so
...
mod tests {
    ...
    #[test]
    #[cfg(zcash_unstable = "nu7")]
    fn migrate_requeues_scanned_nu7_range_from_activation() {
